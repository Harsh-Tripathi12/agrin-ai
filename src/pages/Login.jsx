                ...
                <div className="relative hidden md:flex min-h-[600px] flex-col justify-between overflow-hidden bg-[#174c2c] p-10 text-white">
                    ...
                    <div className="relative z-10 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-200 fill-mode-both">
                        ...
                        <p className="mt-5 max-w-sm text-sm leading-7 text-green-50/75">
                            Log in to check the latest insights and recommendations tailored for your fields.
                        </p>
                    </div>
                </div>

                {/* Form Area */}
                <div className="flex flex-col justify-center px-6 py-12 sm:px-12 md:px-14 lg:px-16 animate-in fade-in duration-700">
                    ...
                    <div className="w-full max-w-sm mx-auto">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5 animate-in slide-in-from-bottom-4 duration-500 delay-150 fill-mode-both">
                            ...
                            {error && (
                                <div className="rounded-xl bg-red-50 p-3 text-sm font-medium text-red-600 animate-in shake duration-300">
                                    {error}
                                </div>
                            )}
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full rounded-xl bg-[#16a34a] px-5 py-3.5 text-sm font-semibold text-white shadow-lg shadow-green-600/25 transition-all hover:bg-green-700 hover:scale-[1.02] active:scale-[0.98] disabled:pointer-events-none disabled:opacity-70 flex items-center justify-center mt-2"
                            >
                                {loading ? (
                                    <>
                        ...
                        <p className="mt-8 text-center text-sm font-medium text-gray-600 animate-in fade-in slide-in-from-bottom-2 duration-500 delay-300 fill-mode-both">
                            ...
                            <Link to="/signup" className="text-[#16a34a] hover:text-green-800 transition-colors">
                                Create one
                            </Link>
                        </p>
                    </div>
